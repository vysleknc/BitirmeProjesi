...
public class ShopHomeService {
	...
	public List<ProductLine> getAllMensShoes() {
		...
		List<ProductLine> mensShoes = productLineRepository.findByCategory(ProductCategory.Freezer);
	...
	public List<ProductLine> getAllWomensShoes() {
		...
		List<ProductLine> womensShoes = productLineRepository.findByCategory(ProductCategory.WashingMachine);
